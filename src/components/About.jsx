...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-32 bg-gray-50 dark:bg-zinc-950/30 transition-colors duration-500"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-10 -right-10 p-10 bg-white/80 dark:bg-white/5 backdrop-blur-2xl border border-gray-200 dark:border-white/10 rounded-[2.5rem] hidden md:block shadow-xl dark:shadow-none">
              ...
              <div className="text-[10px] uppercase tracking-[0.2em] text-gray-500 font-bold leading-relaxed">
                {t.about.exp}
              </div>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-sm uppercase tracking-[0.3em] text-cyan-600 dark:text-cyan-500 font-bold mb-6">
              {t.about.subtitle}
            </h2>
            <h3 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tracking-tighter mb-8 leading-tight">
              ...
              <span className="text-gray-400 dark:text-gray-500 italic font-light">
                clean, functional
              </span>{" "}
              {t.about.title.split("clean, functional")[1]}
            </h3>
